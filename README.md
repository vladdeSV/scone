...
# scone · [![build status](https://github.com/vladdeSV/scone/workflows/build/badge.svg)](https://github.com/vladdeSV/scone/actions?query=workflow%3Abuild) [![test status](https://github.com/vladdeSV/scone/workflows/test/badge.svg)](https://github.com/vladdeSV/scone/actions?query=workflow%3Atest) [![license](https://img.shields.io/github/license/vladdeSV/scone?color=black)](https://github.com/vladdeSV/scone/blob/develop/LICENSE)
