...
**This is an on-going rewrite of v2, and some fundamental features might not work properly.** There might be days where printing to the screen does not work. I highly suggest you use the latest stable release `v2.1.3` (not the `develop` branch!) if you plan to use scone (for now).
