...
# scone · [![build status](![build+test](https://github.com/vladdeSV/scone/workflows/build+test/badge.svg))](https://github.com/vladdeSV/scone/actions?query=workflow:build+test) [![license](https://img.shields.io/github/license/vladdeSV/scone?color=black)](https://github.com/vladdeSV/scone/blob/develop/LICENSE)
